              ...
              <form className="main_form" key="submit_form">
                <div className="furniture_list" key="furniture_div">
                  ...
                  <input
                    ...
                    type="date"
                    key={"inp_user" + 2}
                    onChange={(e) => handleChangeStartDate(2, e.target.value)}
                    value={room.start_dates[2]}
                  />
                  <br></br>
                  {new_block.map((ele, index) => (
                    <>
                      ...
                      >
                        ...
                        >
                          {ele.type === "bed" ? (
                            <div key={"div_select_" + index + "" + 5}></div>
                          ) : (
                            <></>
                          )}
                          <textarea
                          ...
                          >
                            ...
                            <div
                              ...
                              onClick={() => {
                                handleChangeRoomFile(5, index, "images", []);
                              }}
                            >
